        ...
        <>
            ...
            <div className="w-full md:w-3/4 px-4 mb-5 mt-5 ms-10">
                <div className="rounded-lg dark:border-gray-700">
                        <h1 className="text-3xl pt-2 mb-3 text-gray-900">Owner List</h1>
                    <div className="relative  shadow-md sm:rounded-lg">
                        <div className="flex items-center justify-end py-4 bg-white dark:bg-gray-900 mb-1">
                                                    ...
                                                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                        ...
                                                        <div className="p-6 text-center">
                                                            ...
                                                            <button
                                                                ...
                                                                type="button"
                                                                onClick={() =>
                                                                    blockUnblockOwner(data?._id, data?.is_blocked)
                                                                }
