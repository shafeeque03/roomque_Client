  ...
  return (
    <div>
      <div className="bg-slate-50">
        ...
        <button
          type="button"
          className="text-white bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center m-4 ms-7"
        >
          <Link to="/owner/addRoom">+ Add Room</Link>
        </button>

        <div className="flex flex-wrap justify-evenly bg-slate-50 min-h-screen" >
          {rooms.map((room)=>(
