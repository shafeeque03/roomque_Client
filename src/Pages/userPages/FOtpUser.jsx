  ...
  const onSubmit = async () =>{
    try {
      ...
      if(res?.data?.status){
        ...
        navigate("/newPassword", {state: {userId:userId}})
    }
    } catch (error) {
                ...
                <form onSubmit={handleSubmit}>
                  <div className="flex flex-col space-y-16">
                    ...
                    <div className="flex flex-col space-y-5">
                      <div>
                        <button
                          className="flex flex-row items-center justify-center text-center w-full border rounded-xl outline-none py-5  border-none text-white text-sm shadow-sm input-submit"
                          type="submit"
                        >
                          Verify Account
                        </button>
