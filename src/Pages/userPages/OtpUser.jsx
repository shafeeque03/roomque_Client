...
const OtpUser = () => {
  ...
  console.log(userEmail,"emaillllll");
  ...
  return (
    <>
      <div className="relative wrapper flex min-h-screen flex-col justify-center overflow-hidden bg-green-500 py-12">
      <h1 class="text-green-900 text-4xl items-center text-center m-5 font-semibold">roomque</h1>
            ...
            <div className="mx-auto flex w-full max-w-md flex-col space-y-16">
              <div className="flex flex-col items-center justify-center text-center space-y-2">
                ...
                <div className="flex flex-row text-sm font-medium text-gray-400">
                  <p className='text-white'>We have sent a code to your email {userEmail}</p>
                </div>
              </div>
                ...
                <form onSubmit={handleSubmit}>
                  <div className="flex flex-col space-y-16">
                    ...
                    <div className="flex flex-col space-y-5">
                      <div>
                        <button
                          className="flex flex-row items-center justify-center text-center w-full border rounded-xl outline-none py-5 input-submit border-none text-white text-sm shadow-sm"
                          type="submit"
                        >
                          Verify Account
                        </button>
