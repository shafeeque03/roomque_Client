...
export const addRoom = async (roomFormData,roomImage) => {
    const data = await ownerAxiosInstance.post('/addRoom', { ...roomFormData },roomImage);
    return data;
  };
...
export const myRoomList = async (ownerId) => {
  ...
  export const verifyPassword = async (password,ownerId) => {
    const data = await ownerAxiosInstance.patch("/verifyPassword",{password,ownerId})
    return data
  }
